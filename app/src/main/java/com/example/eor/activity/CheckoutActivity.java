...
import com.example.eor.api.PaymentsUtil;
...
public class CheckoutActivity extends Activity {
   ...
   */
  String title,imageLink,postPrice;
  ...
  public void requestPayment(View view) {
    ...
    String price = PaymentsUtil.microsToString(1000000);
  ...
  private void initItemUI() {
    ...
    Picasso.with(this).load(imageLink).resize(200,200).centerCrop().into(itemImage);
    itemPrice.setText("$" + postPrice);
  }
